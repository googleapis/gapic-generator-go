...
var SupportedBooleanArgs map[string]func() configOption = map[string]func() configOption{
	...
	"emit-resource-specs": enableEmitResourceSpecs,
}
...
type generatorConfig struct {
	...
	// Should ResourceSpecs metadata maps be generated
	emitResourceSpecs bool
...
// Should generation of ResourceSpecs metadata maps be enabled.
func enableEmitResourceSpecs() configOption {
	return func(cfg *generatorConfig) error {
		cfg.emitResourceSpecs = true
		return nil
	}
}
